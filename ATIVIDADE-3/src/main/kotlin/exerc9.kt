//EXERCÍCIO EXTRA 8) - LEIA UM VALOR INICIAL A E UMA RAZÃO R, ENTÃO IMPRIMA UMA SEQUÊNCIA P.G. DE 10 VALORES
import java.util.*
...
fun main() {
    ...
    //TÍTULO DO CÓDIGO
    println("- SEQUÊNCIA DE PROGRESSÃO GEOMÉTRICA -")
